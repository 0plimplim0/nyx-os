...
<div align="center">
  ...
  <br/><br/>
  <!-- Badges -->
  <a href="https://github.com/kazah-png/nyx-os/releases/tag/v5.8.52">
    <img src="https://img.shields.io/badge/release-v5.8.52-00ff9d?style=flat" />
  </a>
  <img src="https://img.shields.io/badge/status-v5.8.52-00ff9d?style=flat" />
...
<div align="center">
  <img src="gui.png?v=3" alt="NyxOS Desktop v5.8.52" width="700" />
...
- **36 syscalls** via `syscall`/`sysret`: `exit`, `write`, `print`, `open`, `read`, `close`, `getpid`, `sbrk`, `fsize`, `exec`, `fork`, `waitpid`, `pipe`, `execve`, `dup2`, `getdents`, `kill`, `signal`, `sigreturn`, `mmap`, `munmap`, `chdir`, `getcwd`, `mkdir`, `unlink`, `ttymode`, `mprotect`, `getprocs`, `readkey`, `dlopen`, `dlsym`, `time`, `sleep`, `setfg`, `socket`, `connect`
