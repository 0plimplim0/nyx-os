  ...
  (function terminal() {
    ...
    var seq = [
      ...
      { type: "out", lines: [
        ...
        '  <span class="m">|  .       \'.</span>',
        '  <span class="m">|  \' /     --\'</span>',
        '  <span class="m">|  .   \'.__\\</span>',
        '  <span class="m">;  :       /</span>',
        '  <span class="m"> ;  .     |            ,</span>',
        '  <span class="m">  ;  .    \\           /|</span>',
        '  <span class="m">   \\  .    \'.       .\'/</span>',
        '  <span class="m">    \'.  \'  . `\'---\'`. `\'</span>',
        '  <span class="m">      `\'-..._____.-\'</span>',
        '  <span class="v">    N Y X O S</span>',
        '  <span class="v">    N I G H T F A L L</span>',
        '  <span class="p">  -------------------------------------</span>',
        '  <span class="k">  OS:</span>         NyxOS x86_64',
        '  <span class="k">  Kernel:</span>     NyxOS 5.7.20 (GUI Suite)',
        '  <span class="k">  Uptime:</span>     00:05:42',
        '  <span class="k">  CPU:</span>        QEMU Virtual CPU',
        '  <span class="k">  Memory:</span>     240 MiB / 256 MiB (6%)',
        '  <span class="k">  Processes:</span>  4',
        '  <span class="k">  Network:</span>    10.0.2.15',
        ''
      ]},
